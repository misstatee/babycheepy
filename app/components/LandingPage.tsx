...
const i18n = {
  th: {
    ...
    stats: [
      { icon: '📦', t: 'ขั้นต่ำการผลิตต่ำ',   s: 'เริ่มต้นเพียง 200 ชิ้น' },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'OEM / ODM', emoji: '🎨', price: 'ราคาโรงงาน', unit: 'ขั้นต่ำ 200 ชิ้น/แบบ', highlight: false,
  ...
  en: {
    ...
    stats: [
      { icon: '📦', t: 'Low MOQ',         s: 'Start from 200 pcs' },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'OEM / ODM', emoji: '🎨', price: 'Factory Price', unit: 'Min. 200 pcs/style', highlight: false,
